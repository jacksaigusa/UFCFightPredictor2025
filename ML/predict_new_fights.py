...
data_test = pl.read_csv("/Users/jacksaigusa/Downloads/UFCPredictor2025/Data/walker_vs_zhang.csv")
...
new_fights_with_names = data_test = pl.read_csv("/Users/jacksaigusa/Downloads/UFCPredictor2025/Data/walker_vs_zhang.csv")
i = 0
seen = set()
...
event_name = "UFC Fight Night: Walker vs. Zhang" ## IMPORTANT: CHANGE EVENT NAME BEFORE SAVING ##
...
prediction_file.write_csv("/Users/jacksaigusa/Downloads/UFCPredictor2025/Data/Predictions/walker_vs_zhang_complete.csv")
