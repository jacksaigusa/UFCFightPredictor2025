...
import csv
from scrape_fighter_stats import db, Fighter, Fight
import sys

app = Flask(__name__)
app.config["SQLALCHEMY_DATABASE_URI"] = "sqlite:///detailed_fighter_stats.db"
db.init_app(app)

app2 = Flask("elo")
app2.config["SQLALCHEMY_DATABASE_URI"] = "sqlite:///elo_fightstats.db"
db2 = SQLAlchemy(app2)
...
def main():
    create_all_tables()
    export_to_csv("elofightstats5122025.csv")
    export_fighter_stats_to_csv("fighter_stats512025.csv")
